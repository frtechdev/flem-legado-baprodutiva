...
<html>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Lista de Despesas de Aplicação Financeira</h2>
                <html:form action="/DespesaAplicacaoFinanceira.do" method="post">
                    <div style="width:100%; text-align:right;">
                        <acesso:verificaPermissao funcionalidade="mtb_fin">
                            <html:button property="" value="Novo" onclick="location.href='DespesaAplicacaoFinanceira.do?metodo=listarDespesasGEM'" styleClass="botao" />
                             &nbsp;
                        ...
                        <display:table id="despesa" name="lista" defaultsort="2" sort="list" export="false" excludedParams="metodo" requestURI="./DespesaAplicacaoFinanceira.do" pagesize="30" class="tabelaDisplay">
