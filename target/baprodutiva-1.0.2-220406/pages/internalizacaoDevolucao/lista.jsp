...
<html>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Lista de Internalizações (Devoluções) Reconhecidas</h2>
                <html:form action="/InternalizacaoDevolucao.do" method="post">
                    <div style="width:100%; text-align:right;">
                        <acesso:verificaPermissao funcionalidade="mtb_fin">
                            <html:button property="" value="Reconhecer" onclick="location.href='InternalizacaoDevolucao.do?metodo=listarDevolucoesGEM'" styleClass="botao" />
                             &nbsp;
                            <html:submit property="metodo" value="excluir" styleClass="botao" onclick="return confirmarExclusao();"/>
                        </acesso:verificaPermissao>
                    </div>
                        
                        <display:table id="internalizacao" name="lista" defaultsort="3" sort="list" export="false" excludedParams="metodo" requestURI="./InternalizacaoDevolucao.do" pagesize="30" class="tabelaDisplay">
