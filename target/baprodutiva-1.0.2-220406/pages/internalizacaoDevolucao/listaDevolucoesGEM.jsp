        ...
        <div id="wrap">
            ...
            <div id="content">
                ...
                <div style="width:100%; text-align:right;">
                    <html:button property="" value="Reconhecer todas" onclick="location.href='InternalizacaoDevolucao.do?metodo=associarTodas'"  />
                </div>                            
                    <display:table id="compromisso" name="lista" defaultsort="2" sort="list" export="false" excludedParams="metodo" requestURI="./InternalizacaoDevolucao.do?metodo=listarDevolucoesGEM" pagesize="30" class="tabelaDisplay">
                        ...
                        <display:column title="">
                            <acesso:verificaPermissao funcionalidade="mtb_fin">
                                <a href="./InternalizacaoDevolucao.do?metodo=associarCompromisso&id=${compromisso.id}&tipo=${compromisso.tipo}&seqLinha=${compromisso.seqLinha}"><img align="middle" src="img/calc.png" width="22" height="22" border="0" alt="Reconhecer Receita"/></a>
