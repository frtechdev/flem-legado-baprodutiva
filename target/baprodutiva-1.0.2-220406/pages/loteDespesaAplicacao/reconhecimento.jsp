    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                ...
                <html:form action="/LoteDespesaAplicacao.do?metodo=salvar" onsubmit="return validar(this);" >
                    ...
                    <table>
                        <tr>
                            <td>Categoria: </td>
                            <td>
                                <html:select property="lote.categoria.id" styleId="categoria">
                                    <html:option value="">Selecione:</html:option>
                                    <html:optionsCollection value="id" label="descricao" name="categorias" />
                                </html:select>
                                <script type="text/javascript" language="javascript">
                                    /* As despesas bancárias entram sempre para categoria 3A, para não amarrar em código java, foi colocado no jsp.*/
                                    var campo = document.getElementById("categoria");
                                    var tamanho = campo.length;
                                    for (i = 0; i < tamanho; i++) {
                                        if (campo[i].text == "Categoria 3A") {
