    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                ...
                <html:form action="/LancamentoAvulso.do?metodo=alterar" method="post" onsubmit="return validar(this)">
                    <html:hidden property="lancamentoAvulso.id" />
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><html:text property="dataPagamento" styleId="dataPagamento" value="${dataPagamento}" size="20" maxlength="10" styleClass="requerido" readonly="true" /><img alt="Selecione uma data" src="img/seletorData.png" onclick="return showCalendar('dataPagamento', '%d/%m/%Y');"/></td>
                        </tr>
                        <tr>
