...
<html>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Novo Período</h2>
                <html:form action="/Periodo.do?metodo=adicionar" onsubmit="return validar(this);" >
                    <table>
                        <tr>
                            <td>POA:</td>
                            <td align="left">
                        ...
                        <tr>
                            <td>Data Inicial: </td>
                            <td><html:text property="dataInicial" styleId="dataInicial" size="10" maxlength="10" styleClass="requerido" /><img  alt="Selecione uma data" src="img/seletorData.png" onclick="return showCalendar('dataInicial', '%d/%m/%Y');"/></td>
                        </tr>
                        <tr>
                            <td>Data Final: </td>
                            <td><html:text property="dataFinal" styleId="dataFinal" size="10" maxlength="100" styleClass="requerido" /><img  alt="Selecione uma data" src="img/seletorData.png" onclick="return showCalendar('dataFinal', '%d/%m/%Y');"/></td>
                        </tr>                        
                        <tr>
                            <td>Descrição: </td>
