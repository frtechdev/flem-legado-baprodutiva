...
<html>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Alterar Planejamento</h2>
                <html:form action="/Planejamento.do?metodo=alterar" onsubmit="return validar(this);" >
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Ativo: </td>
                            <td><html:checkbox styleClass="requerido" property="ativo" /> </td>
                        </tr>
                        <tr>
