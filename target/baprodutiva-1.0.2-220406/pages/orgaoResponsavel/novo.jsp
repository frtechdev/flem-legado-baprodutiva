...
<html>
    <head>
        ...
        <html:javascript formName="orgaoResponsavelForm" method="validar"/>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Novo Órgão Responsável</h2>
                <html:form action="/OrgaoResponsavel.do?metodo=adicionar" onsubmit="return validar(this);" >
                    <table>
                        <tr>
                            <td>Descrição: </td>
