...
<html>
    <head>
        ...
        <html:javascript formName="internalizacaoForm" method="validar" page="1"/>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Alterar Internalizacao</h2>
                <html:form action="/Internalizacao.do?metodo=alterar" onsubmit="return validar(this);" >
