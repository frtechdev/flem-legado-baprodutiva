        ...
        <div id="wrap">
            ...
            <div id="content">
                ...
                <html:form action="/Parcela.do" method="post">
                    ...
                    <display:table id="parcela" name="parcelas" defaultsort="2" sort="list" export="false" excludedParams="metodo" requestURI="./Parcela.do" pagesize="30" class="tabelaDisplay">
                        <display:column > <input type="checkbox" name="ids_exclusao" value="${parcela.id}"/></display:column>
                        <display:column property="valor" title="Valor" format="{0,number,#,##0.00}" style="width: 90%;"/>
