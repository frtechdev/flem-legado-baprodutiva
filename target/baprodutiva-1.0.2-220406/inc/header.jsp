...
<div id="header">
    <a href="Home.do"><img align="left" src="img/logo.gif" alt="Caatinga - Página Inicial"/></a>
...
<div id="subHeader" style="text-align:right; font-size:7pt; color:#8E8E38; font-weight:bold;">
    ...
    <fmt-rt:formatDate value="${hoje}" type="DATE" pattern="dd/MM/yyyy"/>, Olá <c-rt:out value="${usuario.nome}"/> <br>
     &nbsp;
