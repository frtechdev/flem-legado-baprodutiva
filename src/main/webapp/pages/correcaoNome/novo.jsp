...
<html>
    <head>
        ...
        <html:javascript formName="correcaoNomeForm" method="validar" />
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                ...
                <html:form action="/CorrecaoNome.do?metodo=inserir" method="post" onsubmit="return validar(this)">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Correção da descricao:</td>
                            <td><html:text property="descricaoLancamento" value="" size="100" maxlength="500" styleClass="requerido" /></td>
                        </tr>
                        <tr>
                            <td>Valor em real:</td>
                            <td>${valor}</td>
