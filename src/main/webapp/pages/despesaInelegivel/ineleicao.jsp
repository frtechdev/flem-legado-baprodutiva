...
<html>
    <head>
        ...
        <html:javascript formName="ineleicaoForm" method="validar"/>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Ineleger Despesa</h2>
                <html:form action="/DespesaInelegivel.do?metodo=salvarIneleicao" onsubmit="return validar(this);" >
                    <html:hidden property="apdId"/>
                    <html:hidden property="apdTp"/>
                    <table>
                        <tr>
                            <td>Motivo: </td>
                            <td><html:text property="motivo" size="70" maxlength="300"/> </td>
                        </tr>
                        <tr>
