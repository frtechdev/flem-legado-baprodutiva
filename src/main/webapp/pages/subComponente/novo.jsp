...
<html>
    <head>
        ...
        <html:javascript formName="subComponenteForm" method="validar"/>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Novo Subcomponente</h2>
                <html:form action="/SubComponente.do?metodo=adicionar" onsubmit="return validar(this);" >
                    <table>
                        <tr>
                            <td>Componente: </td>
