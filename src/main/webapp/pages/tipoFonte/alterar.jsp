...
<html>
    <head>
        ...
        <html:javascript formName="tipoFonteForm" method="validar" page="1"/>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Alterar SubGrupo</h2>
                <html:form action="/TipoFonte.do?metodo=alterar" onsubmit="return validar(this);" >
