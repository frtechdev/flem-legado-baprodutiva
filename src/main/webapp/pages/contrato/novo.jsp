            ...
            <div id="content">
                ...
                <html:form action="/Contrato.do?metodo=adicionar" onsubmit="return validar(this);" >
                    <table>
                        ...
                        <tr>
                            ...
                            <td align="left">      
                                <html:select styleId="tipo" styleClass="requerido" property="tipo">
                                    ...
                                    <html:option value="NCS">NCS - Serviços de Não Consultorias</html:option>
                                </html:select>
                            </td>                            
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Valor: </td>
                            <td><html:text property="valor" size="15" maxlength="100" styleClass="requerido" /> Ex.: 2500.50 (Dois mil quinhentos e cinquenta)</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Observação:</td>
                            <td><html:textarea property="observacao"  cols="20" rows="2"/></td>
                        </tr>
                        <tr>
