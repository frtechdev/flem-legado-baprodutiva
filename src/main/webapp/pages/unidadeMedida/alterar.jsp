...
<html>
    <head>
        ...
        <html:javascript formName="unidadeMedidaForm" method="validar" page="1"/>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Alterar Unidade de Medida</h2>
                <html:form action="/UnidadeMedida.do?metodo=alterar" onsubmit="return validar(this);" >
