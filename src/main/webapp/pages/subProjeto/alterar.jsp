...
<html>
    <head>
        ...
        <html:javascript formName="subProjetoForm" method="validar"/>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Alterar SubProjeto</h2>
                <html:form action="/SubProjeto.do?metodo=alterar" onsubmit="return validar(this);" >
                    ...
                    <table>
                        <tr>
                            ...
                            <td align="left">
                                <html:select styleClass="requerido" property="componenteId">
                                    <html:optionsCollection name="componentes"
                        ...
                        <tr>
                            ...
                            <td align="left">      
                                <html:select styleId="tipoSubProjetoId" styleClass="requerido" property="tipoSubProjetoId">
