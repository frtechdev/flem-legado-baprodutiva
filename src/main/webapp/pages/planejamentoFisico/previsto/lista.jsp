    ...
    <body onload="adicionar();">
        <div id="wrap">
            ...
            <div id="content">
                ...
                <div id="dadosPanejamento">
                    <html:form action="/ProdutoFisicoPrevisto.do?metodo=adicionar"  onsubmit="return adicionar(this);" >
                                    ...
                                    <table cellpadding="0" cellspacing="0" style="border-style:  solid; border-width: 1px">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="border-bottom-width: 1px; border-bottom-style: solid;">Porcentagem Prevista</th>
                                            </tr>
                                        </thead>
                                        <tbody>
