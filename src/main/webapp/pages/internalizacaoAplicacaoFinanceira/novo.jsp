...
<html>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Nova Aplicação Financeira</h2>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <script type="text/javascript" language="javascript">
                                    /* Java script colocado porque segundo Mara os Aplicações financeiras entram sempre para 4.1 Rendimentos
                                     * para não amarrar em código java, foi colocado no jsp.
                                     */
