    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                ...
                <fieldset>
                    <legend>Dados da Subatividade</legend>
                    <table>
                        <tr>
                            <td>Componente: </td>
                ...
                <html:form action="/AtividadeNovaDescricao.do?metodo=adicionar" onsubmit="return validar(this);" >
                    <html:hidden property="novaDescricao.atividade.id" value="${atividade.id}"/>
                    <table>
                        <tr>
                            <td>POA:</td>
                            <td align="left">
