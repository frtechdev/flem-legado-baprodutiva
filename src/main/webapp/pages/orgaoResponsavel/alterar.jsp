...
<html>
    <head>
        ...
        <html:javascript formName="orgaoResponsavelForm" method="validar" page="1"/>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Alterar Órgão Responsável</h2>
                <html:form action="/OrgaoResponsavel.do?metodo=alterar" onsubmit="return validar(this);" >
