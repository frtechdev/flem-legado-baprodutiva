...
<html>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Lista de Internalizações</h2>
                <html:form action="/Internalizacao.do" method="post">
                    <div style="width:100%; text-align:right;">
                        <acesso:verificaPermissao funcionalidade="mtb_fin">
                            <html:button property="" value="Novo" onclick="location.href='Internalizacao.do?metodo=novo'" styleClass="botao" />
                             &nbsp;
                        ...
                        <display:table id="internalizacao" name="lista" defaultsort="2" sort="list" export="false" excludedParams="metodo" requestURI="./Internalizacao.do" pagesize="30" class="tabelaDisplay">
                            ...
                            <display:column title="" href="./Internalizacao.do?metodo=selecionar" paramId="id" paramProperty="id" ><img align="middle" src="img/edit.png" width="22" height="22" border="0" alt="Alterar"/></display:column>
                            </display:table>
                        </html:form>
                    </div> 
