...
<html>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Associar Lote Bancário à Compromisso</h2>
                <html:form action="/InternalizacaoLoteBancario.do?metodo=filtrarCompromisso">
                   ...
                   <display:table id="compromisso" name="lista" defaultsort="1" sort="list" export="false" excludedParams="metodo" requestURI="./InternalizacaoLoteBancario.do?metodo=associarCompromisso" pagesize="30" class="tabelaDisplay">
                       <display:column property="data" title="Data" format="{0,date,dd/MM/yyyy}"/>
                        ...
                        <display:column title="">
                            <acesso:verificaPermissao funcionalidade="mtb_fin">
                                <a href="./InternalizacaoLoteBancario.do?metodo=reconhecer&idComp=${compromisso.apdId}&tipoComp=${compromisso.apdTp}&seqLinhaComp=${compromisso.seqLinha}"><img align="middle" src="img/select.png" width="22" height="22" border="0" alt="Associar devolução"/></a>
