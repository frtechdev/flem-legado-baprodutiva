    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                ...
                <html:form action="/DespesaDataExibicao.do?metodo=alterar" method="post" onsubmit="return validar(this)">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><html:text property="dataLancamento" styleId="dataLancamento" value="${dataLancamento}" size="20" maxlength="10" styleClass="requerido" readonly="true" /><img alt="Selecione uma data" src="img/seletorData.png" onclick="return showCalendar('dataLancamento', '%d/%m/%Y');"/></td>
                        </tr>
                        <tr>
