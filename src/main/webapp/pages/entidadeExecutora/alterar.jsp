...
<html>
    <head>
        ...
        <html:javascript formName="entidadeExecutoraForm" method="validar" page="1"/>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Alterar EntidadeExecutora</h2>
                <html:form action="/EntidadeExecutora.do?metodo=alterar" onsubmit="return validar(this);" >
