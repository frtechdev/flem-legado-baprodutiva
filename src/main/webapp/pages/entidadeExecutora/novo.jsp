...
<html>
    <head>
        ...
        <html:javascript formName="entidadeExecutoraForm" method="validar"/>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Nova Entidade Executora</h2>
                <html:form action="/EntidadeExecutora.do?metodo=adicionar" onsubmit="return validar(this);" >
                    <table>
                        <tr>
                            <td>Descrição: </td>
