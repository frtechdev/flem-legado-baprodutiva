...
<html>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                <h2>Correção de centro de custo do lançamento</h2>
                <html:form action="/CorrecaoCC.do?metodo=alterar" method="post" onsubmit="return validar(this)">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Cntro de custo:</td>
                            <td>${cc}</td>
                        </tr>
                        <tr>
                            <td>Correção do centro de custo:</td>
                            <td><html:text property="ccLancamento" value="" size="20" maxlength="20" styleClass="requerido" /> </td>
                        </tr>
                        <tr>
