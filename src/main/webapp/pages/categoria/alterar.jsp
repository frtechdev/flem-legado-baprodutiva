...
<html>
    <head>
        ...
        <html:javascript formName="categoriaForm" method="validar" page="1"/>
    ...
    <body>
        <div id="wrap">
            ...
            <div id="content">
                ...
                <html:form action="/Categoria.do?metodo=alterar" onsubmit="return validar(this);" >
                        ...
                        <tr>
                            ...
                            <td>      
                                <html:select styleId="origemId" styleClass="requerido" property="origemId">
                                    ...
                                    <html:option value="APLICACAO_FINANCEIRA" >Aplicação Financeira</html:option>
                                </html:select>
                            </td>
                        </tr>
                        <tr>
                            <td>Planejado em real:</td>
                            <td><html:text property="planejado" style="text-align: right" size="20" maxlength="30" styleClass="requerido" /> (Ex.: 1600000.00)</td>
                        </tr>
                        <tr>
