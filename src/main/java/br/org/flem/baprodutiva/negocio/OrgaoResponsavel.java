...
@Entity
@DataTransferObject
public class OrgaoResponsavel extends BaseDTOAb implements java.io.Serializable {
    ...
    public Set<CompositeFolha> getCompositeFolhas() {
        return compositeFolhas;
    }

    public void setCompositeFolhas(Set<CompositeFolha> compositeFolhas) {
